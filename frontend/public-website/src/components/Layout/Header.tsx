  ...
  return (
    <header className="bg-white shadow-sm">
      <nav aria-label="Main navigation" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile menu panel */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-3 px-4 space-y-2">
            <Link
              to="/"
              onClick={() => setMobileMenuOpen(false)}
              className="block text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded px-3 py-2 text-base font-medium"
            >
              Home
            </Link>
            <Link
